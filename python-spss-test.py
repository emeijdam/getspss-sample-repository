...
def get_site_package_info(python3_executable):
    spss_python_config = {}
    spss_python_config['python3_executable'] = python3_executable
    spss_python_config['site_usersitepackages'] = site.getusersitepackages()
    spss_python_config['site_sitepackeges'] = site.getsitepackages()
    spss_python_config['USER_SITE'] = site.USER_SITE
...
def package_manager(package_list, install_if_not_exists=False):
    ...
    print(get_site_package_info(python3_executable))
    packages_status_dict = get_pkg_installed_dict(packages)     
    create_table(packages_status_dict)     
